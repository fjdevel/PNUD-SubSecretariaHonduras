<?php get_header(); ?>
            ...
            <p class="center-text error-text-home"><?php echo esc_html__('... or just go safe', 'cardea-wp');?> <a href="<?php echo esc_url(site_url('/')); ?>"><?php echo esc_html__('Home', 'cardea-wp');?></a></p>            
<?php get_footer(); ?>